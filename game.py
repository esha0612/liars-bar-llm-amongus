...
if __name__ == "__main__":
    player_configs = [
        {"name": "Sarah",     "model": "ollama/llama3"},
        {"name": "Anika",     "model": "ollama/mistral:7b"},
        {"name": "Derek",     "model": "ollama/mistral:latest"},
        {"name": "Emma",      "model": "ollama/llama3"},
        {"name": "Noah",      "model": "ollama/mistral:7b"},
        {"name": "James",     "model": "ollama/mistral:latest"},
        {"name": "George",    "model": "ollama/llama3"},
        {"name": "Hannah",    "model": "ollama/mistral:7b"},
        {"name": "Christian", "model": "ollama/mistral:latest"},
        {"name": "Monica",    "model": "ollama/llama3"},
